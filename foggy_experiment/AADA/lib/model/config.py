...
__C.TRAIN.LEARNING_RATE = 0.00005 # chnaegd from 0.001 to 0.0001
...
__C.TRAIN.SNAPSHOT_ITERS = 10000 #2000 for fine tuning 10000 for traing from scratch
...
def cfg_from_list(cfg_list):
  ...
  #print("length of cfg_list=:",len(cfg_list))
